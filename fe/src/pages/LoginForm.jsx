...
export default function Home() {
  ...
  const slides = [
    <img src="/images/shoes2.jpg" alt="Image 1" className="object-cover"/>,
    <img src="/images/shoes3.jpg" alt="Image 2" className="object-cover"/>,
    <img src="/images/shoes4.jpg" alt="Image 3" className="object-cover"/>,
